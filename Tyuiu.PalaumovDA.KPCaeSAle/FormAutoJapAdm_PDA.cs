...
{
    public partial class FormAutoJapAdm_PDA : Form
    {
        ...
        public FormAutoJapAdm_PDA()
        {
            ...
            rbuttonSearchAutJapAdm_PDA.BackColor = Color.FromArgb(94, 34, 123);
            rbuttonSearchCarID_PDA.BackColor = Color.FromArgb(94, 34, 123);
            rbuttonChangeUserMain_PDA.BackColor = Color.FromArgb(94, 34, 123);
            rbuttonEditAutoJapanAdm_PDA.BackColor = Color.FromArgb(94, 34, 123);
            rbuttonEditAutoJapanAdm_PDA.BackColor = Color.FromArgb(94, 34, 123);
            rbuttonDeleteAutoJapAdm_PDA.BackColor = Color.FromArgb(94, 34, 123);
            ...
            dataGridViewAutoJapAdm_PDA.ReadOnly = true;


            FillBrandComboBox();
            comboBoxBrandAdmin_PDA.SelectedIndexChanged += comboBoxBrandAdmin_PDA_SelectedIndexChanged;
            dataGridViewAutoJapAdm_PDA.CellFormatting += dataGridViewAutoJapAdm_PDA_CellFormatting;

            this.FormClosing += FormAutoJapAdm_PDA_FormClosing;

            dataGridViewAutoJapAdm_PDA.AutoGenerateColumns = false;
        }

        private void FormAutoJapAdm_PDA_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void FillBrandComboBox()
        {
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT DISTINCT Brand FROM autojapan";
        ...
        private void FillModelComboBox(string selectedBrand)
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT DISTINCT Model FROM autojapan WHERE Brand = @Brand";
        ...
        private void rbuttonSearchAutJapAdm_PDA_Click(object sender, EventArgs e)
        {
            string selectedBrand = comboBoxBrandAdmin_PDA.SelectedItem?.ToString();
            ...
            dataGridViewAutoJapAdm_PDA.Rows.Clear();
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT * FROM autojapan WHERE Brand = @Brand AND Model = @Model ORDER BY CASE WHEN Status = 'Активна' THEN 1 ELSE 2 END, Status";
                    ...
                    using (MySqlCommand command = new MySqlCommand(query, connection))
                    {
                        ...
                        using (MySqlDataReader reader = command.ExecuteReader())
                        {
                            if (reader.HasRows)
                            {
                                while (reader.Read())
                                {
                                    int rowIndex = dataGridViewAutoJapAdm_PDA.Rows.Add();
                                    DataGridViewRow row = dataGridViewAutoJapAdm_PDA.Rows[rowIndex];
        ...
        private void FormAutoJapAdm_PDA_Load(object sender, EventArgs e)
        {
            dataGridViewAutoJapAdm_PDA.DefaultCellStyle.Font = new Font("Microsoft Sans Serif", 14);
            dataGridViewAutoJapAdm_PDA.ColumnHeadersDefaultCellStyle.Font = new Font("Microsoft Sans Serif", 14);

            dataGridViewAutoJapAdm_PDA.CellClick += dataGridViewAutoJapAdm_PDA_CellClick;
        ...
        private void LoadAutoJapData()
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT * FROM autojapan ORDER BY CASE WHEN Status = 'Активна' THEN 1 ELSE 2 END, Status";
                    using (MySqlCommand command = new MySqlCommand(query, connection))
                    {
                        using (MySqlDataReader reader = command.ExecuteReader())
                        {
        ...
        {
            if (e.RowIndex >= 0 && (e.ColumnIndex == dataGridViewAutoJapAdm_PDA.Columns["Photo1"].Index || e.ColumnIndex == dataGridViewAutoJapAdm_PDA.Columns["Photo2"].Index ||  e.ColumnIndex == dataGridViewAutoJapAdm_PDA.Columns["Photo3Watch"].Index || e.ColumnIndex == dataGridViewAutoJapAdm_PDA.Columns["Photo4Watch"].Index || e.ColumnIndex == dataGridViewAutoJapAdm_PDA.Columns["Photo5Watch"].Index))
            {
                DataGridViewImageCell cell = dataGridViewAutoJapAdm_PDA.Rows[e.RowIndex].Cells[e.ColumnIndex] as DataGridViewImageCell;
        ...
        //private void dataGridViewAutoJapAdm_PDA_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        //{
        //    if (e.RowIndex >= 0 && (e.ColumnIndex == dataGridViewAutoJapAdm_PDA.Columns["Photo1"].Index || e.ColumnIndex == dataGridViewAutoJapAdm_PDA.Columns["Photo2"].Index))
        //    {
        //        string imagePath = dataGridViewAutoJapAdm_PDA.Rows[e.RowIndex].Cells[e.ColumnIndex].Value.ToString();

        //        if (!string.IsNullOrEmpty(imagePath) && System.IO.File.Exists(imagePath))
        //        {
        //            Image image = Image.FromFile(imagePath);
        //            e.PaintBackground(e.CellBounds, true);
        //            e.Graphics.DrawImage(image, e.CellBounds.Left + 1, e.CellBounds.Top + 1, e.CellBounds.Width - 2, e.CellBounds.Height - 2);
        //            e.Handled = true;
        //        }
        //    }
        //}

        private void rbuttonSearchCarID_PDA_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dataGridViewAutoJapAdm_PDA.Rows)
            {
                string carID = Convert.ToString(row.Cells["CarID"].Value);
                if (carID.Equals(searchValue))
                {
                    row.Selected = true;
                    dataGridViewAutoJapAdm_PDA.CurrentCell = row.Cells["CarID"];
                    found = true; 
                    break;
                }
            }
        ...
        private void dataGridViewAutoJapAdm_PDA_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                dataGridViewAutoJapAdm_PDA.Rows[e.RowIndex].Selected = true;
            }
        }
        private void rbuttonEditAutoJapanAdm_PDA_Click(object sender, EventArgs e)
        {
            if (dataGridViewAutoJapAdm_PDA.SelectedRows.Count == 0)
            {
                MessageBox.Show("Выберите запись для редактирования", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            DataGridViewRow selectedRow = dataGridViewAutoJapAdm_PDA.SelectedRows[0];
        ...
        private void rbuttonDeleteAutoJapAdm_PDA_Click(object sender, EventArgs e)
        {
            if (dataGridViewAutoJapAdm_PDA.SelectedRows.Count == 0)
            {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    using (MySqlCommand command = new MySqlCommand(query, connection))
                    {
                        ...
                        if (rowsAffected > 0)
                        {
                            rbuttonSearchAutJapAdm_PDA_Click(sender, e);
                        }
                        else
                        {
        ...
        private void rbuttonExportExcellAdm_PDA_Click(object sender, EventArgs e)
        {
            ...
            for (int col = 0; col < dataGridViewAutoJapAdm_PDA.Columns.Count; col++)
            {
                wsh.Cells[1, col + 1] = dataGridViewAutoJapAdm_PDA.Columns[col].HeaderText;
            }

            for (int i = 0; i < dataGridViewAutoJapAdm_PDA.Rows.Count; i++)
            {
                for (int j = 0; j < dataGridViewAutoJapAdm_PDA.Columns.Count; j++)
                {
                    wsh.Cells[i + 2, j + 1] = dataGridViewAutoJapAdm_PDA[j, i].Value?.ToString();
                }
            }
